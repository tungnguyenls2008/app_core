...
class BackendTransferExport implements FromView,ShouldAutoSize,WithStyles,WithColumnFormatting
{
    ...
    public function view(): View
    {
        ...
        $balanceChangeTransfers = BalanceChangeTransfer::withoutTrashed()->where(['deleted_at' => null])->whereIn('merchant_id',$sub_merchant)->OrderBy('created_at', 'desc');
        if (isset($search[1])) {
        ...
        return view('_backend.balance_change_transfers.export',['balanceChangeTransfers'=>$balanceChangeTransfers]);
