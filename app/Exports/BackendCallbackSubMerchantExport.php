...
class BackendCallbackSubMerchantExport implements FromView,ShouldAutoSize,WithStyles,WithColumnFormatting
{
...
//            ->where(function ($query) use ($sub_merchant) {
//                $query->whereIn('merchant_id',$sub_merchant)
...
//            ->whereIn('merchant_id',$sub_merchant)
        ...
        return view('_backend.balance_change_callbacks_sub_merchants.export',['balanceChangeCallbacks'=>$balanceChangeCallbacks]);
    }
