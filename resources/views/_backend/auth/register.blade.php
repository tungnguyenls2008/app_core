...
@section('content')
    <div class="card card-primary">
        <div class="card-header"><h4>BACKEND Register</h4></div>

        <div class="card-body pt-1">
            <form method="POST" action="{{ route('backend-register') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
    ...
    <div class="mt-5 text-muted text-center">
        Already have an account ? <a
                href="{{ route('backend-login') }}">SignIn</a>
    </div>
@endsection
