...
<div class="col-md-12 border">
    {!! Form::model($merchants, ['route' => 'sub-merchants.index','method'=>'get']) !!}
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <?php
            $merchants = \App\Models\Merchant::withoutTrashed()->where(['is_sub_merchant'=>1])->select(['merchant_id', 'name'])->get();
            $merchant_select = '';
    ...
    <div class="form-group" style="text-align: center">
        ...
        <a href="{{route('sub-merchants.index')}}"> Hủy</a>
        <div><?php
            if (isset($count)) {
