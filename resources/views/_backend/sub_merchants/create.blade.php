    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="filter-container section-header-breadcrumb row justify-content-md-end">
                <a href="{{ route('sub-merchants.index') }}" class="btn btn-primary">Quay lại</a>
            </div>
        </div>
        <div class="card card-primary">
            ...
            <div class="card-body pt-1">
                ...
                <form method="POST" action="{{ route('sub-merchant-register') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="is_sub_merchant" name="is_sub_merchant" value="1">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="phone">Số điện thoại:</label><span
                                    class="text-danger">*</span>
                                <input id="phone"
