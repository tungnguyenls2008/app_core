    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang('Đổi mật khẩu')</h5>
                <button type="button" aria-label="Close" class="close outline-none" data-dismiss="modal">×</button>
            </div>
            <form method="POST" id='changePasswordForm' action="{{ route('password-change') }}">
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        <label>@lang('Mật khẩu hiện tại'):</label><span
                    ...
                    <div class="form-group col-sm-12">
                        <label>@lang('Mật khẩu mới'):</label><span
                                class="required confirm-pwd"></span><span class="required">*</span>
                        <div class="input-group">
                    ...
                    <div class="form-group col-sm-12">
                        <label>@lang('Xác nhận mật khẩu mới'):</label><span
                                class="required confirm-pwd"></span><span class="required">*</span>
                        <div class="input-group">
                ...
                <div class="text-right">
                    <button type="submit" class="btn btn-primary" id="btnPrPasswordEditSave" data-loading-text="<span class='spinner-border spinner-border-sm'></span> Processing...">@lang('Cập nhật')</button>
                    <button type="button" class="btn btn-light ml-1" data-dismiss="modal">@lang('Hủy')
                    </button>
                </div>
            </div>
            </form>
